...
selectTeamMember :: PrepQuery R (TeamId, UserId) (Identity (Permissions, UserId, UTCTimeMillis))
selectTeamMember = "select perms, invited_by, invited_at from team_member where team = ? and user = ?"

selectTeamMembers :: PrepQuery R (Identity TeamId) (UserId, Permissions, UserId, UTCTimeMillis)
...
insertTeamMember :: PrepQuery W (TeamId, UserId, Permissions, UserId, UTCTimeMillis) ()
